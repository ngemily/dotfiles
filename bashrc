...
# alias cd=cd_func
export DISPLAY=:0.0
export ANT_HOME=/etc/apache-ant-1.8.3
export PATH=$PATH:/cygdrive/c/Android/android-sdk/platform-tools:$ANT_HOME/bin
export PATH=$PATH:/cygdrive/c/Android/android-ndk-r8/
export JAVA_HOME=/cygdrive/c/Program\ Files/Java/jdk1.6.0_31
...
# Navigation
alias home='cd c:/users/emily/desktop/penyopal'
alias desk='cd c:/users/emily/desktop/'
alias docs='cd /cygdrive/d/documents/'
